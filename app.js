...
// Delete everything
await bicycles.deleteMany();
let instance1 = new bicycles({brand: "Lady Bird", type: "Normal", price: 56});
instance1.save().then(doc=>{
console.log("First object saved")}).catch(err=>{
console.error(err)});

let instance2 = new bicycles({brand: "Hero", type: "Medium", price: 55});
instance2.save().then(doc=>{
console.log("Second object saved")}).catch(err=>{
console.error(err)});

let instance3 = new bicycles({brand:"Atlas", type: "Hybrid", price: 42});
